...
import { loginUser as loginUserService } from '@/features/auth/services/auth-api.js';
...
export const useAuthFeatureStore = defineStore('authFeature', () => {
  ...
  const error = ref(null); // For displaying login errors in the component
  ...
  return {
    ...
    currentUser: computed(() => rootAuthStore.user),
  };
}); 